...
declare const Heading: _stitches_react_types_styled_component.StyledComponent<"p", {
...
declare const Button: _stitches_react_types_styled_component.StyledComponent<"button", {
    variant?: "primary" | "secondary" | "terciary" | undefined;
...
export { Avatar, type AvatarProps, Box, type BoxProps, Button, type ButtonProps, Checkbox, type CheckboxProps, Heading, type HeadingProps, MultiStep, type MultiStepProps, Text, TextArea, type TextAreaProps, TextInput, type TextInputProps, type TextProps, Toast, type ToastProps, Tooltip, type TooltipProps, createTheme, css, getCssText, globalCss, keyframes, styled, theme };
